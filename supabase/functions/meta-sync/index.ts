...
Deno.serve(async (req) => {
  ...
  try {
    ...
    return json({ erro: "action inválida. Use: sync_bms | sync_accounts | sync_pages | sync_insights | start_sync_accounts | retry_failed_accounts | auto_archive_no_permission | unarchive_account" }, 400);
  } catch (err) {
